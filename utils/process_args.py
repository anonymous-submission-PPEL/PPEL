...
def _process_args():
    ...
    parser.add_argument('--which_splits', type=str, default="5folds", help='where are splits')
    ...
    parser.add_argument('--pin_memory', type=int, choices=[0, 1], default=1, help='enable dataloader pin_memory when using CUDA')
    ...
    parser.add_argument('--reg', type=float, default=1e-4, help='weight decay / L2 (default: 1e-5)')
    parser.add_argument('--max_cindex', type=float, default=0.0, help='maximum c-index')

    #---> model related
    parser.add_argument('--method', type=str, default="PPEL", help='method type')
    ...
    parser.add_argument('--alpha', type=float, default=0.1, help="legacy argument; unused by PPEL")
    parser.add_argument('--beta', type=float, default=0.01, help="legacy argument; unused by PPEL")
    parser.add_argument('--gamma', type=float, default=1.0, help="legacy argument; unused by PPEL")
    parser.add_argument('--sigma', type=float, default=0.1, help="weight for PPEL complementarity loss")
    parser.add_argument('--theta', type=float, default=0.1, help="weight for PPEL pathway evidence recovery loss")
    parser.add_argument('--ratio_wsi', type=float, default=0.5, help='top-k WSI patch ratio for pathway-conditioned evidence localization')
    parser.add_argument('--comp_margin', type=float, default=0.75, help='margin for PPEL complementarity loss')
    parser.add_argument('--use_pel', type=int, choices=[0, 1], default=1, help='enable pathway-conditioned evidence localization')
    parser.add_argument('--use_mel', type=int, choices=[0, 1], default=1, help='enable pathway-aware morphological evidence learning loss')
    parser.add_argument('--use_cgf', type=int, choices=[0, 1], default=1, help='enable complementarity-gated fusion')
    parser.add_argument('--ratio_omics', type=float, default=0.8, help='legacy argument; unused by PPEL')
